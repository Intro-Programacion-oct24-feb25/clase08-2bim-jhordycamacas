...
public class Principal1 {
    ...
    public static String presentarReporte(String nom, String ap, String correo,
            String notas, double prom, int numeroNotas, int alta, int baja) {
        String reporte = String.format("Nombres: %s\n"
                ...
                + "Nota mas alta: %d\n"
                + "Nota mas baja: %d\n\n",
                nom, ap, correo, notas, prom, numeroNotas, alta, baja);
    ...
    public static String obtenerCorreo(String nom, String ape) {
        String correo;
        nom = nom.toLowerCase();
        ape = ape.toLowerCase();
